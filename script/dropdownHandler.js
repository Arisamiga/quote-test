...
(function () {
    ...
    selections.addEventListener("change", (event) => {
        ...
        if (selectedOption === "Hopkins") {
            let html = "";
            const premadeOption = "Hopkins"
                html += `
                <div class='headline'>
                    <h1>G.M. Hopkins</h1>
                </div>
    ...
    selectionData.addEventListener("click", (event) => {
        ...
        if (element.classList.contains("grid_item")) {
            ...
            let act = event.target.parentElement.parentElement.previousElementSibling.textContent.trim();
